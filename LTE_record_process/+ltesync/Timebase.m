...
%TIMEBASE Single owner of file position and LTE frame/subframe numbering.
    ...
    methods
        ...
        function reset(obj, lock)
            ...
            if isfield(lock, 'ReportedRawSampleRateHz')
                obj.ReportedRawSampleRateHz = ...
                    double(lock.ReportedRawSampleRateHz);
            else
                obj.ReportedRawSampleRateHz = obj.RawSampleRateHz;
            end
        ...
        function meta = currentMeta(obj)
            ...
            meta = struct( ...
                ...
                'ReportedRawSampleRateHz', obj.ReportedRawSampleRateHz, ...
                'LteSampleRateHz', obj.LteSampleRateHz, ...
                'TimestampSeconds', ...
                startSample0/obj.ReportedRawSampleRateHz, ...
